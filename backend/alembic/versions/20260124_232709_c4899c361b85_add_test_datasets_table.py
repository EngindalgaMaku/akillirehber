...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('audit_logs_target_user_id_fkey'), 'audit_logs', type_='foreignkey')
    op.drop_constraint(op.f('audit_logs_admin_user_id_fkey'), 'audit_logs', type_='foreignkey')
    op.create_foreign_key(None, 'audit_logs', 'users', ['admin_user_id'], ['id'])
    op.create_foreign_key(None, 'audit_logs', 'users', ['target_user_id'], ['id'])
    ...
    op.drop_index(op.f('ix_chat_messages_course_user_id'), table_name='chat_messages')
    ...
    op.alter_column('documents', 'embedded_at',
               ...
               type_=sa.DateTime(),
               existing_nullable=True)
    op.drop_constraint(op.f('evaluation_results_run_id_fkey'), 'evaluation_results', type_='foreignkey')
    op.drop_constraint(op.f('evaluation_results_question_id_fkey'), 'evaluation_results', type_='foreignkey')
    op.create_foreign_key(None, 'evaluation_results', 'test_questions', ['question_id'], ['id'])
    op.create_foreign_key(None, 'evaluation_results', 'evaluation_runs', ['run_id'], ['id'])
    op.drop_constraint(op.f('evaluation_runs_test_set_id_fkey'), 'evaluation_runs', type_='foreignkey')
    op.create_foreign_key(None, 'evaluation_runs', 'test_sets', ['test_set_id'], ['id'])
    op.drop_constraint(op.f('giskard_summaries_run_id_key'), 'giskard_summaries', type_='unique')
    op.drop_index(op.f('ix_quick_test_results_course_id'), table_name='quick_test_results')
    op.drop_index(op.f('ix_quick_test_results_group_name'), table_name='quick_test_results')
    ...
    op.drop_constraint(op.f('run_summaries_run_id_fkey'), 'run_summaries', type_='foreignkey')
    op.create_foreign_key(None, 'run_summaries', 'evaluation_runs', ['run_id'], ['id'])
    op.drop_index(op.f('ix_semantic_similarity_results_batch_session_id'), table_name='semantic_similarity_results')
    op.drop_index(op.f('ix_semantic_similarity_results_course_id'), table_name='semantic_similarity_results')
    op.drop_constraint(op.f('temporary_passwords_user_id_fkey'), 'temporary_passwords', type_='foreignkey')
    op.create_foreign_key(None, 'temporary_passwords', 'users', ['user_id'], ['id'])
    op.drop_constraint(op.f('test_questions_test_set_id_fkey'), 'test_questions', type_='foreignkey')
    op.create_foreign_key(None, 'test_questions', 'test_sets', ['test_set_id'], ['id'])
